  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-app-green relative items-center justify-center">
        <img className=" absolute inset-0 object-cover h-full bg-center opacity-10" src={heroSectionData.hero_image} alt="" />
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <label className=" text-sm flex flex-col gap-1">
              ...
              <button type="submit" disabled={loading} className=" flex-center w-full py-3 bg-green-950 text-white font-semibold rounded-xl hover:bg-green-900 transition-colors disabled:opacity-50">
                {loading ? <Loader2 className=" animate-spin " /> : isLoginState ? "Sign In" : "Create Account" }
              </button>
